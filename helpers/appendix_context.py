...
def appendix_context(doc: DocxTemplate):
    context = {
        # Population tables (2006, 2011, 2016, 2021)
        "table41": df_to_table_with_columns(get_table41(report_input.community_cd)),
        # Headship rate by region (2006, 2021)
        "table42": df_to_table_with_columns(get_table42(report_input.geo_code_list)),
        # Dwellings by year of construction (cumulative)
        "table43": df_to_table_with_columns(get_table43(report_input.community_cd)),
        # Dwellings by structural type and year of construction
        "table44": df_to_table_with_columns(get_table44(report_input.community_cd)),
        # Dwellings by structural type and number of bedrooms
        "table45": df_to_table_with_columns(get_table45(report_input.community_cd)),
        # Income cost tables 2016
        "table46": df_to_table_with_columns(get_table46(report_input.community_cd)),
        "table47": df_to_table_with_columns(get_table47(report_input.geo_code_list)),
        # Shelter cost tables 2016
        "table48": df_to_table_with_columns(get_table48(report_input.community_cd)),
        "table49": df_to_table_with_columns(get_table49(report_input.geo_code_list)),
        # Income cost tables 2021
        "table50": df_to_table_with_columns(get_table50(report_input.community_cd)),
        "table51": df_to_table_with_columns(get_table51(report_input.geo_code_list)),
        # Shelter cost tables 2021
        "table52": df_to_table_with_columns(get_table52(report_input.community_cd)),
        "table53": df_to_table_with_columns(get_table53(report_input.geo_code_list)),
        # Total households by hh size
        "table54": df_to_table_with_columns(get_table54_56(report_input.geo_code_list, 2006)),
        "table55": df_to_table_with_columns(get_table54_56(report_input.geo_code_list, 2016)),
        "table56": df_to_table_with_columns(get_table54_56(report_input.geo_code_list, 2021)),
        # Total households by income
        "table57": df_to_table_with_columns(get_table57_59(report_input.geo_code_list, 2006)),
        "table58": df_to_table_with_columns(get_table57_59(report_input.geo_code_list, 2016)),
        "table59": df_to_table_with_columns(get_table57_59(report_input.geo_code_list, 2021)),
